...
st.title("NFL Monte Carlo Simulation and Correlation Analysis")

# Sidebar navigation for different pages
page = st.sidebar.selectbox("Choose a Page", ["Monte Carlo Simulation", "Correlation Analysis", "Login", "Register"])
